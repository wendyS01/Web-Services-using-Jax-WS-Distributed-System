 ...
 * A jmDNS was implemented to register auldfellas service
 *
 *
 */
@WebService
...
public class Quoter extends AbstractQuotationService {
        ...
        public static void main(String[] args) {
                try {
                        ...
                        String config = "path=http://"+host+":9001/quotation" +
                                        "?wsdl";
                        ServiceInfo auldfellasService = ServiceInfo.create(
                                        "_quote._tcp.local.", "auldfellas",
                                        9001, config);
